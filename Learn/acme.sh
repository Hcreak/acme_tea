...
_calcjwk() {
  ...
  # -----------------------------------------------------------------
    ...
    # $ openssl ec -in account -noout -text
    # read EC key
    # Private-Key: (521 bit)
    # priv:
    #     01:d4:3d:f6:84:2e:2d:ee:06:5b:1d:c4:d1:94:ef:
    #     ab:b7:e5:2e:1d:39:89:fa:3c:81:c6:8b:fd:c3:a6:
    #     a6:a6:ac:21:30:a5:28:48:bd:72:f2:25:d7:eb:c7:
    #     d6:ee:0d:ac:b4:96:82:d9:bc:c3:c4:05:70:5d:b4:
    #     b1:ba:dd:5b:b8:1e
    # pub:
    #     04:01:f7:35:27:ff:0f:b2:80:9c:db:9c:10:c4:b1:
    #     68:35:4d:dd:8c:5e:c0:e3:30:4e:bb:06:2f:72:a4:
    #     eb:b4:1f:ed:ef:fc:80:ed:2f:f6:c8:3b:e8:d0:61:
    #     ae:e9:07:32:55:6d:7b:ea:8a:12:2a:c5:2a:dd:d0:
    #     f2:84:43:ae:cb:14:2f:01:cf:60:1a:fe:89:65:eb:
    #     22:39:07:25:ab:18:50:c6:54:46:ec:fe:74:46:b5:
    #     5e:d0:17:a1:cf:70:15:2d:68:f1:72:4c:bc:02:6d:
    #     35:11:2f:3e:f9:1c:fc:4e:c9:c9:d6:07:43:8a:9b:
    #     4c:bb:d3:46:d5:6b:54:bb:68:1a:a7:5d:d1
    # ASN1 OID: secp521r1
    # NIST CURVE: P-521

    _debug3 crv "$crv"   # P-521
    __ECC_KEY_LEN=$(echo "$crv" | cut -d "-" -f 2)  # 521
    if [ "$__ECC_KEY_LEN" = "521" ]; then
      __ECC_KEY_LEN=512  # 注：521bit椭圆曲线 对应哈希SHA-512 因为不存在521bit的哈希算法
    fi
    _debug3 __ECC_KEY_LEN "$__ECC_KEY_LEN"

    # 若未标记为NIST椭圆曲线 则检查ASN1标识
    # 然而下面三条曲线都有NIST标识的 为什么要分开判断呢？ WTF?!
    if [ -z "$crv" ]; then
    ...
    # 获得公钥开始的行号 (pub 标识的后一行)
    pubi="$(${ACME_OPENSSL_BIN:-openssl} ec -in "$keyfile" -noout -text 2>/dev/null | grep -n pub: | cut -d : -f 1)"
    pubi=$(_math "$pubi" + 1)
    _debug3 pubi "$pubi"  # 9

    # 获得公钥结束的行号 (ASN1 OID 标识的前一行)
    pubj="$(${ACME_OPENSSL_BIN:-openssl} ec -in "$keyfile" -noout -text 2>/dev/null | grep -n "ASN1 OID:" | cut -d : -f 1)"
    pubj=$(_math "$pubj" - 1)
    _debug3 pubj "$pubj"  # 17

    # 根据开始结束行号抽取公钥 并去掉换行
    pubtext="$(${ACME_OPENSSL_BIN:-openssl} ec -in "$keyfile" -noout -text 2>/dev/null | sed -n "$pubi,${pubj}p" | tr -d " \n\r")"
    _debug3 pubtext "$pubtext"

    # 04:01:f7:35:27:ff:0f:b2:80:9c:db:9c:10:c4:b1:68:35:4d:dd:8c:5e:c0:e3:30:4e:bb:06:2f:72:a4:eb:b4:1f:ed:ef:fc:80:ed:2f:f6:c8:3b:e8:d0:61:ae:e9:07:32:55:6d:7b:ea:8a:12:2a:c5:2a:dd:d0:f2:84:43:ae:cb:14:2f:01:cf:60:1a:fe:89:65:eb:22:39:07:25:ab:18:50:c6:54:46:ec:fe:74:46:b5:5e:d0:17:a1:cf:70:15:2d:68:f1:72:4c:bc:02:6d:35:11:2f:3e:f9:1c:fc:4e:c9:c9:d6:07:43:8a:9b:4c:bb:d3:46:d5:6b:54:bb:68:1a:a7:5d:d1

    # 计算公钥字符串去掉:后 16bit分一组后的长度？
    xlen="$(printf "%s" "$pubtext" | tr -d ':' | wc -c)"
    xlen=$(_math "$xlen" / 4)
    _debug3 xlen "$xlen"  # 66
    ...
    # 01:f7:35:27:ff:0f:b2:80:9c:db:9c:10:c4:b1:68:35:4d:dd:8c:5e:c0:e3:30:4e:bb:06:2f:72:a4:eb:b4:1f:ed:ef:fc:80:ed:2f:f6:c8:3b:e8:d0:61:ae:e9:07:32:55:6d:7b:ea:8a:12:2a:c5:2a:dd:d0:f2:84:43:ae:cb:14:2f

    # 取出的 x 字符串去掉: 转二进制 做base64url输出
    ...
    # 01:cf:60:1a:fe:89:65:eb:22:39:07:25:ab:18:50:c6:54:46:ec:fe:74:46:b5:5e:d0:17:a1:cf:70:15:2d:68:f1:72:4c:bc:02:6d:35:11:2f:3e:f9:1c:fc:4e:c9:c9:d6:07:43:8a:9b:4c:bb:d3:46:d5:6b:54:bb:68:1a:a7:5d:d1

    # 取出的 y 字符串去掉: 转二进制 做base64url输出
    ...
    # {"crv": "P-521", "kty": "EC", "x": "'$x64'", "y": "'$y64'"}

    JWK_HEADER='{"alg": "ES'$__ECC_KEY_LEN'", "jwk": '$jwk'}'
    JWK_HEADERPLACE_PART1='{"nonce": "'
    JWK_HEADERPLACE_PART2='", "alg": "ES'$__ECC_KEY_LEN'"'

    # 注：521bit椭圆曲线 对应哈希SHA-512 因为不存在521bit的哈希算法
    # {"alg": "ES512", "jwk": {"crv": "P-521", "kty": "EC", "x": "'$x64'", "y": "'$y64'"}}
  # -----------------------------------------------------------------
